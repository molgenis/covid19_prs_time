...
main <- function(argv=NULL) {
  ...
  ugliPathPval <- "/groups/umcg-lifelines/tmp01/projects/ov20_0554/analysis/risky_behaviour/PRS_correlation/pgs_correlation_output_linear_model_all_quest_v30_final_20_all_genome_participants_test_with_cof/all_part_lin_new_ugli/EduYears/covid_export_correlations_EduYears_p_values_allParti_new_lin_ugli_23-05-2021.txt"
  ugliPathCorr <- "/groups/umcg-lifelines/tmp01/projects/ov20_0554/analysis/risky_behaviour/PRS_correlation/pgs_correlation_output_linear_model_all_quest_v30_final_20_all_genome_participants_test_with_cof/all_part_lin_new_ugli/EduYears/covid_export_correlations_EduYears_correlations_allParti_new_lin_ugli_23-05-2021.txt"
  ...
  cytoPathPval <- "/groups/umcg-lifelines/tmp01/projects/ov20_0554/analysis/risky_behaviour/PRS_correlation/pgs_correlation_output_linear_model_all_quest_v30_final_20_all_genome_participants_test_with_cof/all_part_lin_new_cyto/EduYears/covid_export_correlations_EduYears_p_values_allParti_new_lin_cyto_23-05-2021.txt"
  cytoPathCorr <- "/groups/umcg-lifelines/tmp01/projects/ov20_0554/analysis/risky_behaviour/PRS_correlation/pgs_correlation_output_linear_model_all_quest_v30_final_20_all_genome_participants_test_with_cof/all_part_lin_new_cyto/EduYears/covid_export_correlations_EduYears_correlations_allParti_new_lin_cyto_23-05-2021.txt"
  ...
  metaPathPval <- "/groups/umcg-lifelines/tmp01/projects/ov20_0554/analysis/pgs_correlations/analyses/20211125/regenerate_baseline_output/output/EduYears/covid_meta_analysis_pvalues_EduYears_20-01-2022.txt"
  metaPathCorr <- "/groups/umcg-lifelines/tmp01/projects/ov20_0554/analysis/pgs_correlations/analyses/20211125/regenerate_baseline_output/output/EduYears/covid_meta_analysis_correlations_EduYears_20-01-2022.txt"
  ...
  write.table(
    table_annotated_2,
    file.path(base_path, "covid_combined_EduYears_results_cyto_ugli_meta_baseline_18_02_2022.txt"),
