...
qOverviewFile <- "/groups/umcg-lifelines/tmp01/projects/ov20_0554/analysis/pgs_correlations/quest_overview_nl_new_quest17_codes_updated_14-days-include-complete-qof.txt"
longitudinalSamplesFile <- "output/longitudinalSamples_NoGenotypeData.txt"
validationSamplesFile <- "output/validationSamples_NoGenotypeData.txt"
inclusionPrVlFile <- "output/inclusionPerVl_NoGenotypeData.txt"
...
pdf("output/missingPerVl_NoGenotypeData.pdf")
...
png("output/barplot.png", width = 1000, height = 1000)
barplot(table(qpp))
dev.off()
...
png(paste0("output/pcPerWeek/", vl, ".png"))
