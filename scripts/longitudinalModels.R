...
qPrs <- qVsPrsRecode2[qVsPrsRecode2[,"prsTrait"] == "Depression..broad." & qVsPrsRecode2[,"question2"] == "bedroefd...in.welke.mate.heeft.u.zich.de.afgelopen.14.dagen.zo.gevoeld.",]
